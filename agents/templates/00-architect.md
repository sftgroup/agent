# AGENTS.md — team3 v13.2 (极致精简版 · 吸收 Team2 下沉哲学)
...
cast call $CORE "nonces(address)(uint256)" $USER --rpc-url $SEPOLIA_RPC_URL
cast code $CORE --rpc-url $SEPOLIA_RPC_URL | wc -c
cast balance $VAULT --rpc-url $SEPOLIA_RPC_URL
...
| Key | 地址 | ETH |
|-----|------|----:|
| PK_3 | 0xAc44609887c76Bf15ce480189fB289dF1af797C8 | 0.196 |
| PK_4 | 0x9e7c5a9Bc8495D7A01FB636fcE7bE3014b0702e0 | 0.197 |
| PK_5 | 0x7850AA8B728D200608630CBb9E0B78fd68afC282 | 0.194 |
| PK_6 | 0x2868aE0F9710028FA2aD24af9B6a8bB745c0ea49 | 2.450 |
| PK_7 | 0xe79457B9bf208f93aaE2b5b1A464aA36ADb99E6a | 0.198 |
| PK_8 | 0x43eC42e5D6be70A98F7444843628dAef0C1bfEC4 | 0.286 |
| PK_9 | 0x5C0b2430BB847813f1a2009C42403E09C26507a3 | 0.211 |
| DEPLOYER | 0xA13F7D12F997771af66aC24E4526821bfA8D84eE | 0.190 |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v13.2 | 07-08 | **吸收 Team2 下沉哲学**：路径体系→精简为关键报告路径表(§10)、自检→加入项目类型路由+SSH隧道(§4)、流程→文字版去掉ASCII图(§8)、参考文档→精简(§14)。保留 spawn 模板(§5)+cast(§7)。365→~280行 |

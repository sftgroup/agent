...
> ⚠️ 腾讯云安全组需要放行对应端口（TCP）。当前 9001 外网不通，需在控制台配置。
...
# 4. 验证
curl http://127.0.0.1:90XX/health
```
...
| 端口 | 服务名 | systemd unit | 描述 |
|------|--------|-------------|------|
| 9001 | code-review | code-review-mcp.service | 代码质量：lint/format/types/complexity/deps |
